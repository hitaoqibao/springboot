package com.example.springbootmybatisplus.Generator;
...
public class CodeGenerator {
  ...
  public static void main(String[] args) {
    ...
    dsc.setUrl("jdbc:mysql://localhost:3306/demo?serverTimezone=CTT&characterEncoding=utf-8&useSSL=false");
    ...
    pc.setParent("com.example.springbootmybatisplus").setMapper("dao"); // mapper文件夹改为dao
