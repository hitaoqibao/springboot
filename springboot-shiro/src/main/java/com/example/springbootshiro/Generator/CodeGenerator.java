...
public class CodeGenerator {
  ...
  public static void main(String[] args) {
    ...
    dsc.setUrl("jdbc:mysql://localhost:3306/shiro?serverTimezone=CTT&characterEncoding=utf-8&useSSL=false");
    ...
    pc.setParent("com.example.springbootshiro").setMapper("dao"); // mapper文件夹改为dao
